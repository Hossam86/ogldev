...
namespace ogl
{
	...
	public:
		...
		void
		CalcLocalDirection(const WorldTrans& worldTransform);
	...
	public:
		...
		void
		CalcLocalPosition(const WorldTrans& worldTransform);
	...
	public:
		...
		void
		CalcLocalDirectionAndPosition(const WorldTrans& worldTransform);
