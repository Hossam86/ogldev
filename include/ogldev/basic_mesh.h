...
private:
	...
	void
	LoadDiffuseTexture(const string& Dir, const aiMaterial* pMaterial, int MaterialIndex)
	{
	...
	void
	LoadSpecularTexture(const string& Dir, const aiMaterial* pMaterial, int MaterialIndex)
	{
