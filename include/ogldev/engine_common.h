...
#define SHADOW_CUBE_MAP_TEXTURE_UNIT GL_TEXTURE8
#define SHADOW_CUBE_MAP_TEXTURE_UNIT_INDEX 8
#define SHADOW_MAP_RANDOM_OFFSET_TEXTURE_UNIT GL_TEXTURE9
#define SHADOW_MAP_RANDOM_OFFSET_TEXTURE_UNIT_INDEX 9
#define DETAIL_MAP_TEXTURE_UNIT GL_TEXTURE10
#define DETAIL_MAP_TEXTURE_UNIT_INDEX 10
